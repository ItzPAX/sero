...
static OQS_STATUS example_stack(void) {
	...
	printf("[example_stack] OQS_SIG_ml_dsa_44 operations completed.\n");
	cleanup_stack(secret_key, OQS_SIG_ml_dsa_44_length_secret_key);
	return OQS_SUCCESS; // success!

#else

	printf("[example_stack] OQS_SIG_ml_dsa_44 was not enabled at compile-time.\n");
	return OQS_ERROR;
...
static OQS_STATUS example_heap(void) {
	...
	if (sig == NULL) {
		printf("[example_heap]  OQS_SIG_alg_ml_dsa_44 was not enabled at compile-time.\n");
		return OQS_ERROR;
	}
	...
	printf("[example_heap]  OQS_SIG_alg_ml_dsa_44 operations completed.\n");
	cleanup_heap(public_key, secret_key, message, signature, sig);
	return OQS_SUCCESS; // success
}
